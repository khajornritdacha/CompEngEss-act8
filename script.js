...
const config = {
  region: "us-east-1",
  credentials: {
    accessKeyId: "ASIAS5BZOHDXZFSLA6HJ",
    secretAccessKey: "VNMV6p68srlQ6Hw+UETTKb9D72ecMMJR9VhOSWK/",
    sessionToken:
      "",
  },
};
...
async function addMember() {
  ...
  const studentIdString = document
    ...
    .value.trim();
  const fullnameString = document
    .getElementById("fullname-to-add")
    .value.trim();
  const nicknameString = document
    .getElementById("nickname-to-add")
    .value.trim();
