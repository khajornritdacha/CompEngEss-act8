...
document.getElementById("food-random-button").addEventListener("click", randomFood);
// =============================================================================================================
...
async function addMember() {
    ...
    const studentIdString = document.getElementById("student-id-to-add").value.trim();
